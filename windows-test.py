...
class TestTarFunction(unittest.TestCase):
    ...
    def test_tar_function(self):
        ...
        # # Create a folder and move test files into it
        ...
        #     if e.errno != errno.EEXIST:
        #         raise
        # shutil.move('file1.txt', os.path.join(folder_name, 'file1.txt'))
        # shutil.move('file2.txt', os.path.join(folder_name, 'file2.txt'))

        # # Test creating a new archive with folder name as input
        # tar(mode='c', archive='archive-folder.tar', sfiles=folder_name)

        # # Verify the archive was created
        # self.assertTrue(os.path.exists('archive-folder.tar'))
