...
async function copyFiles() {
  ...
  const source_path = AWS_REGION?.startsWith('cn-') ?
    `aws-gcr-solutions/extension-for-stable-diffusion-on-aws/1.4.1/${ESD_VERSION}`
    : `aws-gcr-solutions-us-east-1/extension-for-stable-diffusion-on-aws/1.4.1/${ESD_VERSION}`;
