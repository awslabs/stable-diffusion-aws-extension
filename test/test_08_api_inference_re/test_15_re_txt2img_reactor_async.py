...
class TestTxt2ImgReReactorAsyncE2E:
    ...
    def test_1_txt2img_re_reactor_async_create(self):
        ...
        upload_with_put(inference_data["api_params_s3_upload_url"], "./data/api_params/reactor.json")

    def test_2_txt2img_re_reactor_async_exists(self):
        global inference_data
        assert inference_data["type"] == InferenceType.TXT2IMG.value
    ...
    def test_5_txt2img_re_reactor_async_start_and_succeed(self):
        global inference_data
        assert inference_data["type"] == InferenceType.TXT2IMG.value
    ...
    def test_6_txt2img_re_reactor_async_delete_succeed(self):
