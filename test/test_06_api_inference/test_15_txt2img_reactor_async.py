...
class TestTxt2ImgReactorAsyncE2E:
    ...
    def test_2_txt2img_reactor_async_exists(self):
        global inference_data
        assert inference_data["type"] == InferenceType.TXT2IMG.value
    ...
    def test_5_txt2img_reactor_async_start_and_succeed(self):
        global inference_data
        assert inference_data["type"] == InferenceType.TXT2IMG.value
    ...
    def test_6_txt2img_reactor_async_delete_succeed(self):
