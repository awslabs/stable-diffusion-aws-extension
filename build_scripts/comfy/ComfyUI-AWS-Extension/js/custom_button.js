            ...
            [
                $el("table.comfy-modal-content.comfy-table", [
                    ...
                    $el(
                        "tr",
                        [
                            $el("th", { textContent: "Instance Type", style: { border: "0", width: "15%"  } }),
                            ...
                            $el("th", { textContent: "Auto-Scale", style: { border: "0", width: "15%"  } }),
                            $el("td", {style: { width: "15%" } }, [
                                $el("select", {
                            ...
                            $el("th", { textContent: "Init Count", style: { border: "0" , width: "15%" } }),
                            $el("td", {style: { width: "15%" } }, [
                                $el("input", {
                                    type: "text",
                ...
                $el("table.comfy-modal-content.comfy-table", [
                    ...
                    $el(
                        ...
                        [
                            ...
                            $el("th", { textContent: "", style: { border: "0", style: "width: 5%" } }),
                        ]
                    ),
                    $el(
                        "tr",
