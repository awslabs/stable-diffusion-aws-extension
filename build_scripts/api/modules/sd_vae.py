...
def get_base_vae(model):
    if base_vae is not None and checkpoint_info == shared.opts.data["sd_checkpoint_info"] and model:
        return base_vae
    return None
...
def store_base_vae(model):
    ...
    if checkpoint_info != shared.opts.data["sd_checkpoint_info"]:
        assert not loaded_vae_file, "Trying to store non-base VAE!"
        base_vae = deepcopy(model.vae)
