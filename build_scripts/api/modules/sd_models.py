...
def reload_pipeline_weights(sd_pipeline=None, info=None):
    ...
    if pipeline_data.sd_pipeline is None:  # previous model load failed
        ...
        if shared.opts.data["sd_model_checkpoint_path"] == checkpoint_info.filename and ('inpainting' in checkpoint_info.filename or 'Inpaint' not in shared.sd_pipeline.pipeline_name):
           return
