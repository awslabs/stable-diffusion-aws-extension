...
class Api:
    def __init__(self, app: FastAPI, queue_lock: Lock):
        ...
        self.add_api_route("/ping", self.ping, methods=["GET"], reponse_model=models.PingResponse)
...
try:
    ...
    def txt2img_pipeline(self, txt2imgreq: models.StableDiffusionTxt2ImgProcessingAPI):
        # TODO: re-write scripts to continue achieve same function
        ...
        with closing(StableDiffusionProcessingTxt2Img(sd_model=None, **args)) as p:
            ...
            if selectable_scripts is not None:
                logger.info("scripts not implemented!")
                # # TODO achieve scripts mode
