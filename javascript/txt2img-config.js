...
function scrap_ui_component_value_with_default(config) {
    ...
    // checkpoint merger 
    config["ckpt_merger_primary_model_name"] = getElementValue(
        "#modelmerger_primary_model_name > label > div > div > div > input",
        "value",
        ""
    );

    config["ckpt_merger_secondary_model_name"] = getElementValue(
        "#modelmerger_secondary_model_name > label > div > div > div > input",
        "value",
        ""
    );

    config["ckpt_merger_tertiary_model_name"] = getElementValue(
        "#modelmerger_tertiary_model_name > label > div > div > div > input",
        "value",
        ""
    );

    config["ckpt_merger_custom_name"] = getElementValue(
        "#modelmerger_custom_name > label > textarea",
        "value",
        ""
    );

    config["ckpt_merger_interp_amount"] = getElementValue(
        "#modelmerger_interp_amount > div > div > input",
        "value",
        ""
    );

    config["ckpt_merger_no_interpolation"] = getElementValue(
        "#modelmerger_interp_method > div > label:nth-child(1) > input",
        "checked",
        false
    );

    config["ckpt_merger_weighted_sum"] = getElementValue(
        "#modelmerger_interp_method > div > label:nth-child(2) > input",
        "checked",
        false
    );

    config["ckpt_merger_add_difference"] = getElementValue(
        "#modelmerger_interp_method > div > label:nth-child(3) > input",
        "checked",
        false
    );

    config["ckpt_merger_save_as_half"] = getElementValue(
        "#modelmerger_save_as_half > label > input",
        "checked",
        false
    );

    config["ckpt_merger_ckpt"] = getElementValue(
        "#modelmerger_checkpoint_format > div > label:nth-child(1) > input",
        "checked",
        false
    );

    config["ckpt_merger_safetensors"] = getElementValue(
        "#modelmerger_checkpoint_format > div > label:nth-child(2) > input",
        "checked",
        false
    );

    config["ckpt_merger_save_metadata"] = getElementValue(
        "#modelmerger_save_metadata > label > input",
        "checked",
        false
    );
    
    config["ckpt_merger_a_b_c"] = getElementValue(
        "#modelmerger_config_method > div > label:nth-child(1) > input",
        "checked",
        false
    );

    config["ckpt_merger_b"] = getElementValue(
        "#modelmerger_config_method > div > label:nth-child(2) > input",
        "checked",
        false
    );

    config["ckpt_merger_c"] = getElementValue(
        "#modelmerger_config_method > div > label:nth-child(3) > input",
        "checked",
        false
    );

    config["ckpt_merger_dont"] = getElementValue(
        "#modelmerger_config_method > div > label:nth-child(4) > input",
        "checked",
        false
    );

    config["ckpt_merger_bak_in_vae"] = getElementValue(
        "#modelmerger_bake_in_vae > label > div > div > div > input",
        "value",
        ""
    );

    config["ckpt_merger_discard_weights_with_name"] = getElementValue(
        "#modelmerger_discard_weights > label > textarea",
        "value",
        ""
    );
}
